    ...
    public void onMouseClickButton(MouseEvent mouseEvent) {
        ...
        if(kpTextField.getText() != "" && kiTextField.getText() != "" && defaultBox.isSelected()) {
            try {
                ...
                Main_GUI.train_Cat_1.set_Defaults(Integer.valueOf(kpTextField.getText()), Integer.valueOf(kiTextField.getText()), (Integer.valueOf(Main_GUI.train_Cat_1.get_Train_Controller(trainEngIndex).get_Number_Of_Cars())), trainEngIndex);
